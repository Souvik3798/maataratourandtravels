                ...
                <div class="col-lg-12">
                    <div class="single_listing">
                        ...
                        <div class="hotel_info">
                            ...
                            <div class="hotel_title_container d-flex flex-lg-row flex-column">
                                <div class="hotel_title_content">
                                    <h1 class="hotel_title" style="color: purple">{{ $details->Service }}</h1>
                            ...
                            <div class="hotel_info_text" style="text-align: justify">
                                <p style="color: black; font-size: 18px">{{ $details->Description }}</p>
                            </div>
                        ...
                        <div class="important_notes">
                            ...
                            <ul>
                                <li style="color: black"><strong>Travel Documents:</strong> Ensure you have all
                                    necessary travel documents,
                                    including a valid passport, visas, and any required identification.</li>
                                <li style="color: black"><strong>Health and Safety:</strong> Follow all health and
                                    safety guidelines,
                                    including any travel advisories or regulations related to COVID-19 or other health
                                    concerns.</li>
                                <li style="color: black"><strong>Insurance:</strong> We highly recommend purchasing
                                    travel insurance to cover
                                    unforeseen circumstances, including trip cancellations, medical emergencies, and
                                    lost luggage.</li>
                                <li style="color: black"><strong>Air Ticketing:</strong> Check your booking confirmation
                                    for accuracy and
                                    report any discrepancies immediately. Arrive at the airport well in advance of your
                                    flight's departure time to allow for check-in and security procedures. Be aware of
                                    your airline's baggage policies, including weight limits and any fees for excess
                                    luggage.</li>
                                <li style="color: black"><strong>Ship Ticketing:</strong> Ensure you have your boarding
                                    pass and any other
                                    required documents before arriving at the port. Arrive at the embarkation point well
                                    in advance to complete necessary boarding procedures. Be aware of any luggage
                                    restrictions or special instructions provided by the shipping company.</li>
                                <li style="color: black"><strong>Car Rental:</strong> Ensure you have a valid driver's
                                    license and any
                                    required permits for the destination country. Read and understand the rental
                                    agreement, including insurance coverage and fuel policies. Inspect the vehicle for
                                    any existing damage before taking possession and report any issues to the rental
                                    company.</li>
                                <li style="color: black"><strong>Hotel Services:</strong> Familiarize yourself with the
                                    hotel's check-in and
                                    check-out times to avoid any additional charges. Verify your reservation details
                                    upon arrival to ensure accuracy. Be aware of the hotel's amenities and services,
                                    including any additional fees that may apply.</li>
                                <li style="color: black"><strong>Water Activities:</strong> Attend all safety briefings
                                    and follow the
                                    instructions of trained professionals. Ensure all equipment provided for water
                                    activities is in good condition and fits properly. Inform the activity provider of
                                    any health conditions or restrictions that may affect your participation.</li>
                            </ul>
                        </div>
