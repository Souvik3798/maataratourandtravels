...
<head>
    ...
    <meta name="description" content="Explore the best holiday tour packages and bespoke travel experiences in Andaman and Nicobar Islands with Andaman Blue Ocean. Your trusted travel partner since 2006.">
					...
					<div class="footer_col">
						<div class="footer_content footer_about">
							<div class="logo_container footer_logo">
								<div class="logo"><a href="{{url('/')}}"><img src={{asset('images/ABS.png')}} height="100" class="rounded" alt=""></a></div>
							</div>
					...
					<div class="footer_col">
						...
						<div class="footer_content footer_tags">
                            ...
                            @foreach ($service as $service)
								<li class="tag_item" style="width: 100%"><a href="{{url('service-details/'.$service->id)}}">{{$service->Service}}</a></li>
                            @endforeach
							</ul>
						</div>
					</div>
					...
					<div class="footer_col">
						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								...
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="{{asset('images/whstapp.png')}}" width="40px" alt=""></div></div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved to Andaman Blue Ocean <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://unicorniz.com/" target="_blank">Unicorniz Innovation Pvt. Ltd.</a>
...
<style>
    ...
    .callus_float {
        position: fixed;
        bottom: 100px; /* Adjust as needed to avoid overlap with WhatsApp button */
        right: 20px;
    }
