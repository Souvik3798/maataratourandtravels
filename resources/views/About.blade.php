			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="intro_content">
						...
						<p class="intro_text" style="text-align: justify">Who wouldn't want to spend a peaceful vacation amidst the stunning natural beauty of the Andaman and Nicobar Islands? These pristine islands promise lifelong memories for those who embark on an adventure here. With the tourism industry experiencing significant growth in recent years, we are a trusted tourism agent in the Andaman Islands, dedicated to helping both domestic and international travelers enjoy their journeys to the fullest.

                            Our motto, "serving with genuine hospitality," is at the heart of everything we do. Established in 2006, <strong>Andaman Blue Ocean</strong> has been a committed tour agent in the Andaman region. Our CEO, Sanjit Debnath, is passionate about providing flawless travel services that allow clients to explore the captivating destinations of the Andaman Islands. Based in Port Blair, Andaman and Nicobar Islands, we aim to showcase the unique history and culture of Andaman, highlighting it as one of the world's most unspoiled destinations.

                            Contact us and make <strong>Andaman Blue Ocean</strong> your travel partner to experience the breathtaking beauty of the Andaman and Nicobar Islands.</p>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1 text-center">
					<p class="stats_text" style="text-align: justify">Since our inception in 2006, <strong>Andaman Blue Ocean</strong> has achieved remarkable milestones. We have successfully organized over 5,000 tours, serving more than 20,000 satisfied clients from around the globe. Our dedication to excellence has earned us numerous accolades, including the prestigious Andaman Tourism Award. We have expanded our services to include bespoke travel packages, ensuring personalized and memorable experiences for every traveler. Our team’s commitment to "serving with genuine hospitality" has cemented our reputation as a trusted and reliable tour operator in the Andaman Islands, continually driving us to set new standards in the travel industry </p>
				</div>
			</div>
			<div class="row">
				<div class="col">
				...
				<div class="col">
					<div class="stats_contents">
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							...
							<div class="stats_bar order-md-2 order-2" data-x="768" data-y="6145" data-color="#a95ce4">
								<div class="stats_bar_perc">
									<div>
										<div class="stats_bar_value"></div>
									</div>
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							...
							<div class="stats_bar order-md-2 order-2" data-x="11546" data-y="19321" data-color="#fa6f1b">
								<div class="stats_bar_perc">
									<div>
										<div class="stats_bar_value"></div>
									</div>
			...
			<div class="row">
				<div class="col">
					<div class="add_container">
						<div class="add_background" style="background-image:url(https://cdn.pixabay.com/photo/2019/02/11/04/25/jail-3988719_1280.jpg)"></div>
